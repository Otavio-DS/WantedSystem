const tentivas = '5' // Numero de tentativas que o jogar tem para acertar a saída
...
function finish(success) {
  ...
  $("body").hide()
  if (success) {
    $.post('https://elite_wanted/succeed', JSON.stringify({}));
  } else {
    $.post('https://elite_wanted/failed', JSON.stringify({}));
  }
}
